...
[![npm version](https://img.shields.io/npm/v/@osjwnpm/enim-incidunt-harum.svg)](https://www.npmjs.com/package/@osjwnpm/enim-incidunt-harum)
[![npm downloads](https://img.shields.io/npm/dw/@osjwnpm/enim-incidunt-harum)](https://www.npmjs.com/package/@osjwnpm/enim-incidunt-harum)
[![Node.js CI](https://github.com/osjwnpm/enim-incidunt-harum/actions/workflows/nodejs.yml/badge.svg)](https://github.com/osjwnpm/enim-incidunt-harum/actions/workflows/nodejs.yml)
...
`npm install @osjwnpm/enim-incidunt-harum`
...
```js
const { Client } = require("@osjwnpm/enim-incidunt-harum") 
// ESM: import { Client } from "@osjwnpm/enim-incidunt-harum"
